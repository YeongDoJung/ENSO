...
from Models_remove_calendar_classification import Model_3D
from parts_cp import datasets_general_3D_alllead
import argparse
...
if __name__ == "__main__":
    ...
    pretrainFolder = ""
    dataFolder = 'c:/code/ENSO/ENSO_Ham/Dataset' #"./"
        ...
        for ens in range(ENS_Start, ENS) :
            ...
            for epoch in range(numEpoch):
                ...
                for i, (batch, ansnino, anstype) in enumerate(trainloader):
                    ...
                    trainloader.set_description(f'train loss : {pLoss:.4f}')
                ...
                with torch.no_grad() :
                    for i, (batch, ansnino, anstype) in enumerate(testloader):
                        ...
                        testloader.set_description(f'val loss : {pLoss:.4f}')

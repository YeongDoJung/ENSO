...
from Models_3DRFB_Attention_LSTM import Model_3D
from Parts import *
import argparse
...
if __name__ == "__main__":
    ...
    lengthscale = 0.0           # Default regularization weight (L2)
    ...
    Folder = "./pretrain_3DRFB_Attention_LSTM"
    pretrainFolder = ""
    ...
    SSTFile_train2 = dataFolder+'/Data_pre_training/cmip5_val.input.1861_2001.nc'
    SSTFile_train_label2 = dataFolder+'/Data_pre_training/cmip5_val.label.1861_2001.nc'
